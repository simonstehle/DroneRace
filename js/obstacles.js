...
var flyThroughHitBoxMaterial = new THREE.MeshBasicMaterial({side: THREE.DoubleSide, transparent: true, opacity:0.3, color: 0x00ff00});
var flyOverHitBoxMaterial = new THREE.MeshBasicMaterial({side: THREE.DoubleSide, color: 0xff0000});
var hitBoxMaterial = new THREE.MeshBasicMaterial({side: THREE.DoubleSide, transparent: true, opacity:0.3, color: 0xff0000});
/**
...
function addTargetRing(innerRadius, outerRadius, positionX, positionY, positionZ, rotationY, parent, movingPace, movingDuration) {
    ...
    basicMaterial.visible = hitBoxesVisible;
    /**
     * Mesh for target circle
     * @type {THREE.Mesh}
     */
    var circleMesh = new THREE.Mesh(circleGeo, flyThroughHitBoxMaterial);
     ...
     * @type {THREE.Mesh}
     */
    var flyOverBox = new THREE.Mesh(flyOverBoxGeometry, flyOverHitBoxMaterial);
    flyOverBox.position.x = positionX;
    flyOverBox.position.z = positionZ;
    flyOverBox.position.y = 0;
     ...
     * @type {THREE.Mesh}
     */
    var hitBoxMesh = new THREE.Mesh(ringGeometry, hitBoxMaterial);
...
function addWallObstacle(width, height, positionX, positionZ, rotationY, flyThroughOnLeft, movingPace, movingDuration) {
    ...
    wallFlyOverBoxMaterial.visible = hitBoxesVisible;
    /**
     * Mesh for wall fly over hit box
     * @type {THREE.Mesh}
     */
    var wallFlyOverBox = new THREE.Mesh(wallFlyOverBoxGeometry, flyOverHitBoxMaterial);

    wallFlyOverBox.position.set(positionX, 0, positionZ);
     ...
     * @type {THREE.Mesh}
     */
    var cylinderFlyOverCircle = new THREE.Mesh(cylinderFlyOverCircleGeo, flyOverHitBoxMaterial);
     ...
     * @type {THREE.Mesh}
     */
    var flyThroughWallMesh = new THREE.Mesh(flyThroughWallGeo, flyThroughHitBoxMaterial);
    ...
    if (flyThroughOnLeft) {
        ...
        targetFlyOverBox.position.set((positionX - width), 0, positionZ);
        cylinderMesh.position.set(positionX - width * 1.5, 0, positionZ);
        cylinderFlyOverCircle.position.set(positionX - width * 1.5, 0, positionZ);
...
function addTargetFrame(width, positionX, positionY, positionZ, rotationY) {
     ...
     * @type {THREE.Mesh}
     */
    var rectMesh = new THREE.Mesh(rectGeo, flyThroughHitBoxMaterial);
...
function addStartLine(width, depth, positionX, positionY, positionZ, rotationY, height) {
     ...
     * @type {THREE.Mesh}
     */
    var startFlyThroughMesh = new THREE.Mesh(startFlyThroughGeo, flyThroughHitBoxMaterial);
     ...
     * * @type {THREE.Mesh}
     */
    var flyOverCircle1 = createFlyOverCircle(positionX - width / 2, 0, positionZ, 80);
    /**
     ...
     * * @type {THREE.Mesh}
     */
    var flyOverCircle2 = createFlyOverCircle(positionX + width / 2, 0, positionZ, 80);
...
function createFlyOverCircle(positionX, positionY, positionZ, radius) {
     ...
     * @type {THREE.Mesh}
     */
    var circleMesh = new THREE.Mesh(circleGeometry, flyOverHitBoxMaterial);
    circleMesh.position.set(positionX, positionY, positionZ);
